...
void readAndSendSensorData() {
  ...
  // Check if IR value is valid
  if (irValue < 50000) { // Adjust threshold based on your sensor's expected range
    Serial.println("Warning: IR value is too low. Check sensor alignment or configuration.");
  }

  // Print only magnitudes to the terminal
  ...
  Serial.print("Raw GSR: "); Serial.println(raw_gsr);
...
void setup() {
  ...
  // Ensure the sensor is properly configured
